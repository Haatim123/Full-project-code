...
data "aws_ami" {  # aws_ami helps to get AMI ID of the os
...
security_groups = [aws_security_group.public_subnet_sg]  # this is security grp in which we have openend ports
root_block_device {
  volume_size = 20
}
tags = {
